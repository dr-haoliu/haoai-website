...
export function Footer() {
  return (
    <footer className="bg-surface-900 dark:bg-surface-950 text-gray-300 dark:text-gray-400 mt-auto">
      <Container>
        <div className="py-12">
            ...
            <div>
              ...
              <form className="flex flex-col space-y-2">
                <input
                  ...
                  className="px-4 py-2 rounded-lg bg-surface-800 dark:bg-surface-800 border border-surface-700 text-white text-sm focus:outline-none focus:ring-2 focus:ring-primary-500"
